...
def get_climate_index(climate_index_name=None, year_range=None):
    ...
    if year_range is not None:
        years = climate_index.index.year
        L = (years>=year_range[0]) & (years<=year_range[-1])
        climate_index = climate_index[L]
